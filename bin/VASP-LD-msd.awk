...
#       print term1,term2,term3
        ...
        sumx[i]=sumx[i]+wght*(term1+term2+term3)*(ex[i,f]*ex[i,f])
        sumy[i]=sumy[i]+wght*(term1+term2+term3)*(ey[i,f]*ey[i,f])
        sumz[i]=sumz[i]+wght*(term1+term2+term3)*(ez[i,f]*ez[i,f])
        sumq[i]=sumq[i]+wght*(term1+term2+term3)*(ex[i,f]*ex[i,f]  +  ey[i,f]*ey[i,f]  +  ez[i,f]*ez[i,f])
      }
    }
